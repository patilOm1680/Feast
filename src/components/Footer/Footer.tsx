...
const Footer = () => {
  return (
    <>
      <footer className="w-full border-t-[2px] border-gray-100 mt-10 px-22">
        <div className="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              <Link
                href="/"
                className="py-2.5 px-5 h-9 block w-fit bg-green-500 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-green-800 lg:mx-0"
              >
                Contact us
              </Link>
            </div>
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-gray-500 ">
                ©<a href="https://pagedone.io/">Feast</a> 2025, All rights
                reserved.
              </span>
