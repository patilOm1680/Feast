  ...
  return (
    <>
      <div className="bg-white shadow fixed w-full py-3 pl-14 z-50">
        <div className="container flex items-center gap-18 justify-between mx-20 pt-2">
          <Link href="/" className=" w-[300px]">
            <img src="/navbar/appLogo.png" className="h-10 w-auto" alt="" loading="eager"/>
          </Link>
          ...
          <nav className="contents">
            <ul className="flex items-center gap-6 justify-end">
              ...
              <img
                ...
                alt="avatar"
                className="relative inline-block h-10 w-10 !rounded-full object-cover object-center ml-6"
              />
            </ul>
          </nav>
